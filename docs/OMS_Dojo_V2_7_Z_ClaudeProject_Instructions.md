...
### Business Approach
- **ONEMANSHYO Dojo:** Open source (GPL), NOT a business
- **DojoLive:** Open source, community tool
...
- Dojo receives audio data, updates visuals
...
**ONEMANSHYO Dojo is a COMPLETE professional production tool, NOT just a content container.**
...
**Name:** ONEMANSHYO Dojo Live (DojoLive)  
...
5. Dojo receives data
6. Dojo updates modulators
...
2. OMS Session (DojoLive evolved)
   - Load audio files
   - Mix audio across decks
   - Real-time FFT analysis
   - Broadcast to Dojo instances
   - Visual compositing
   - MIDI control
...
**Before making changes:**
1. Add this comprehensive instructions file to Claude project
2. Review DojoLive V1.0.0 deliverables
